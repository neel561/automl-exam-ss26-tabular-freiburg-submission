...
def main():
    urls = [
        "https://ml.informatik.uni-freiburg.de/research-artifacts/automl-exam-26-tabular/tabular-phase1.zip",
        "https://ml.informatik.uni-freiburg.de/research-artifacts/automl-exam-26-tabular/tabular-phase2.zip"
    ]
    extract_folder = "data"
